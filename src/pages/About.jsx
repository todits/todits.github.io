...
const About = () => {
   ...
   return (
      <div
         name="about"
         className={`content w-full h-screen ${backgroundColor} ${textColor}`}
      >
         <div className="max-w-screen-xl px-[80px] max-md:pt-[144px] max-md:px-[20px] pt-20 min-[1600px]:pt-28 mx-auto flex flex-col place-content-start w-full h-full">
            ...
            >
               <div className="z-20 relative max-md:fixed max-md:top-[51px] max-md:-ml-[20px] flex place-items-end justify-center w-[2500px] max-md:w-[150px] -ml-[70px] -mr-[30px] group -mb-[1px] ">
               ...
               <div className="py-[40px] pr-[40px] max-md:py-[10px] max-md:pr-[10px] max-md:pl-[10px]">
                  <p className="text-xl max-md:text-[15px] max-md:leading-4">
                  ...
                  <p className="text-xl mt-[30px] max-md:text-[15px] max-md:leading-4">
