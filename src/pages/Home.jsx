         ...
         <div className="w-[100%] flex items-center justify-start h-[100%]  md:flex-col pt-[10vh]">
            <div className="flex mb-[2%]">
               ...
               <h2
                  ...
                  className="text-sm  sm:text-7xl  font-primary text-custom-secondary textshadow"
               >
                  PERSONAL PORTFOLIO
               </h2>
            </div>
            <div className="w-[100%] h-[100%] flex justify-between flex-col">
               <div className="bg-[#bee7e7] ">
                  <div className="flex max-w-screen-lg mx-auto mt-[20px] h-[auto]">
                     <div className="flex flex-col justify-center w-[60%] shadow-md  rounded-lg shadow-custom-secondary p-[20px] bg-white my-[5%]">
               ...
               <div className=" py-[5px] w-full flex justify-center">
                  ...
                  <div className="w-[50%] relative">
                     <img
                        src={Profile}
                        alt="my profile"
                        className="rounded-2xl mx-auto  w-[60vh] min absolute bottom-[-20%] right-[7%]"
                     />
                  </div>
               </div>
            </div>
